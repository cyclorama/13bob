...
sMenu = (o, m) => { menu = !menu,
    ...
    for (let i = 0; i < items[o].length; i++) {
        ...
        document.getElementById('menu').innerHTML += menu ? (
            m == 0 ? `<a style='padding: 13em;' href='${items[o][i]}'><img style='${i > 2 ? `margin-top: ${(400 * fTop) - 1000}px;` : '' } box-shadow: 10px 10px 0px black;' id='menu' src='${items[o][i].replace('//', '')}/logo.webp'/></a>${i != 0 && i % 2 == 0 ? '<br>' : '' }` :
