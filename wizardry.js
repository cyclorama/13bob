...
const nav    =   document.querySelectorAll('[id=nav]');
...
function pFrame(x, y, z)    { document.getElementsByName(nav[x].name)[0].src=`${frame}${nav[x].name}_${z==0?'forward':z==1?'reverse':''}.gif`;pSound(y); }
