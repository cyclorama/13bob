...
function play(frame, d)		{ document.getElementsByName(document.getElementById("nav")[frame])[0].src='photos/framed_'+document.getElementById("nav")[frame]+((d%2)==0?'_forward.gif':'_reverse.gif');sound(frame); }
