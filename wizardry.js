...
function pSound(s) {
	if (s == 0)  { sounds[0][1].pause();sounds[0][1].currentTime=0;sounds[0][0].play();sounds[0][0].volume=0.1; }
	if (s == 1)  { sounds[0][0].pause();sounds[0][0].currentTime=0;sounds[0][1].play();sounds[0][1].volume=0.1; }
	if (s == 2)  { sounds[1][1].pause();sounds[1][1].currentTime=0;sounds[1][0].play();sounds[1][0].volume=0.1; }
	if (s == 3)  { sounds[1][0].pause();sounds[1][0].currentTime=0;sounds[1][1].play();sounds[1][1].volume=0.1; }
	if (s == 10) { sounds[5][1].pause();sounds[5][1].currentTime=0;sounds[5][0].play();sounds[5][0].volume=0.1; }
	if (s == 11) { sounds[5][0].pause();sounds[5][0].currentTime=0;sounds[5][1].play();sounds[5][1].volume=0.1; }
	...
	if (s == 4)  { sounds[2][0].play();sounds[2][0].volume=0.1; }
	if (s == 6)  { sounds[3][0].play();sounds[3][0].volume=0.1; }
	if (s == 8)  { sounds[4][0].play();sounds[4][0].volume=0.1; }
}
