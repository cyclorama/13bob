...
function play(frame, d)		{ document.getElementsByName(document.querySelectorAll('[id=nav]')[frame].name)[0].src='photos/framed_'+document.querySelectorAll('[id=nav]')[frame].name+(d==1?'_forward.gif':d==2?'_reverse.gif':'');sound(frame); }
