...
function play(frame, d)		{ document.getElementsByName(document.querySelectorAll('[id=nav]')[track].name)[0].src='photos/framed_'+document.querySelectorAll('[id=nav]')[track].name+(d==0?'_forward.gif':'_reverse.gif');sound(frame); }
