...
function showMenu(option) {
	document.getElementById("menu").innerHTML = menu ? "<marquee scrollamount='13'><a href='dreaming_in_digital/fisher'><img id='menu' src='dreaming_in_digital/menu_" + option + "_" + item + ".png'/></a></marquee>" : "";
}
