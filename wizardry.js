...
function play(n, s, d)	{ document.getElementsByName(document.querySelectorAll('[id=nav]')[n].name)[0].src='photos/framed_'+document.querySelectorAll('[id=nav]')[n].name+(d==1?'_forward.gif':d==2?'_reverse.gif':'');sound(s); }
