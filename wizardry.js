...
function showMenu(option)	{ document.getElementById("menu").innerHTML="";menu=!menu;for(var i=0;i<items[option].length;i++){document.getElementById("menu").innerHTML+=menu?"<a href='"+items[option][i]+"'><img style='right:13em;' id='menu' src='"+items[option][i]+"/logo.png'/></a><br>":"";} }
