...
function showMenu(option)	{ document.getElementById("menu").innerHTML="";menu=!menu;for(var i=0;i<items[option].length;i++){document.getElementById("menu").innerHTML+=menu?"<marquee style='padding:4em;' scrollamount='13'><a href='"+items[option][i]+"'><img id='menu' src='"+items[option][i]+"/logo.png'/></a></marquee>":"";} }
